...
#SBATCH -e train_N2n4_%j.err
#SBATCH -o train_N2n4_%j.out # File to which STDOUT will be written %j is the job #
...
srun torchrun --nproc_per_node=4 --nnodes=2 --rdzv_id=$RANDOM --rdzv_endpoint=$head_node_ip:29500 --rdzv_backend=c10d bin/train_ddp.py --config=config/crystallm_v5_large_N2n4.yaml
